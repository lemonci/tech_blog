...
$$\begin{eqnarray} ^1 \dot{\omega}_1 &=& ^1_0R \cdot ^0\dot{\omega}_0 + ^1_0R \cdot ^0\omega_0 \times ^1\omega_1 + \ddot{\theta}_1 \cdot ^1Z_1 = 0 + 0 + \begin{pmatrix} 0\\ 0\\ \ddot{\theta}_1 \end{pmatrix} = \begin{pmatrix} 0\\ 0\\ \ddot{\theta}_1 \end{pmatrix} \end{eqnarray}$$$$\begin{eqnarray} ^1 \dot{v}_1 &=& ^1_0R \cdot(^0\dot{\omega}_0 \times ^0P_1 + ^0\omega_0 \times (^0\omega_0 \times {^0} P_1)+^0\dot{v}_1)=^1_0R \cdot(0+0+-\overrightarrow{G}) =\begin{pmatrix} \sin_1g\\ \cos_1g\\ 0 \end{pmatrix} \end{eqnarray}$$
